...
Check: /etc/apt/sources.list
    ...
    docker-repo must be deactivated.
    In my bbb 2.4 installations there is a second entry for universe.

deb http://archive.ubuntu.com/ubuntu bionic universe

You may disable that too. Both entries in /etc/apt/sources.list should look like this:
...
reboot and do-release-upgradeto Ubuntu 22.04
